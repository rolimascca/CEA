...
SECRET_KEY = 'django-insecure-rq3x)0g5d(u=_quv)2^j-0c1obw%(+^(bu_u0707vb7fermi!2'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'),  # Usar os.path.join aquí
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Usar os.path.join aquí también
]
